...
sudo yum install -y --disablerepo=* --enablerepo=foundation  consul vault terraform 
sudo yum install -y --disablerepo=* --enablerepo=foundation  orchestrator  ipahelper ui-setup rpminstall azmgr 
